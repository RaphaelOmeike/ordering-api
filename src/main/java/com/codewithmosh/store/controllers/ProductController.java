...
public class ProductController {
    ...
    @GetMapping
    public List<ProductDto> getProductsByCategory(@RequestParam(required = false, name = "categoryId") Byte categoryId) {
        List<Product> products;
        if (categoryId != null) {
//            my way
//            products = productRepository.findByCategory(new Category(categoryId));
